...
export class ArticlesComponent implements OnInit {
  ...
  delete(articles: IArticles): void {
    const modalRef = this.modalService.open(ArticlesDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.articles = articles;
  ...
  protected fillComponentAttributesFromResponseBody(data: IArticles[] | null): IArticles[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.articlesService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
