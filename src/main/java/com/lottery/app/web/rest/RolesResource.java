...
/**
 * REST controller for managing {@link com.lottery.app.domain.Roles}.
 */
@RestController
...
public class RolesResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<RolesDTO>> getAllRoles(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<RolesDTO> getRoles(@PathVariable("id") Long id) {
